...
username = os.environ.get("freedom_username")
password = os.environ.get("freedom_password")
...
for domain, days, renewal_id in domains:
    ...
    if days < 14:
        ...
        print(domain,
              '续期成功' if r.text.find('Order Confirmation') != -1 else '续期失败')
